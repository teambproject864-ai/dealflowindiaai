...
export const APP_FEATURES: Feature[] = [
  ...
  {
    id: "a2a-communication-protocol",
    name: "Agent-to-Agent (A2A) Communication Protocol",
    description: "Standardized, interoperable protocol enabling seamless message passing, capability negotiation, task delegation, and state synchronization between all connected agents with protocol validation and comprehensive logging.",
    category: "Core Platform",
    iconName: "Network",
    status: "active",
    isNew: true,
  ...
  },
  {
    ...
    description: "Production-grade Graph RAG framework that unifies structured knowledge graphs with retrieval-augmented generation, featuring automated knowledge graph construction, entity resolution, relationship mapping, dynamic updates, and vector-based hybrid search.",
    category: "AI & Automation",
    iconName: "Graph",
    status: "active",
    isNew: true,
  ...
  {
    id: "context-graph-layer",
    name: "Context Graph Layer for Multi-Agent Memory",
    description: "Centralized memory infrastructure storing interaction histories, agent states, task outcomes, and shared contextual data with granular access controls, memory lifecycle management (auto-pruning, relevance prioritization), and version control for critical memory entries.",
    category: "Core Platform",
    iconName: "Memory",
    status: "active",
    isNew: true,
  ...
  {
    id: "unified-orchestration-layer",
    name: "Unified Orchestration Layer",
    description: "Complete end-to-end orchestration system managing task distribution, context sharing, and memory synchronization across all agents, with built-in event-driven architecture and seamless integration with A2A, Graph RAG, and Context Graph components.",
    category: "Core Platform",
  ...
  },
  {
    ...
    name: "End-to-End Observability System",
    description: "Comprehensive observability including distributed tracing, centralized logging, and performance monitoring to track the entire system's operation with real-time metrics, event logs, and trace visualization.",
    category: "Analytics & Reporting",
    iconName: "Monitor",
    status: "active",
    isNew: true,
  ...
  },
  {
    ...
    description: "Conversational AI assistant that dynamically converts natural language business questions into structured Firestore database queries and executes live analytics.",
    category: "AI & Automation",
    iconName: "Bot",
    status: "active",
    isNew: true,
  ...
  {
    id: "gtm-playbook-module",
    name: "Customer GTM Playbook Engine",
    description: "Interactive playbook studio enabling agents and customers to view, edit, save executive summaries, and generate strategic GTM resources.",
    category: "AI & Automation",
    iconName: "FileText",
    status: "active",
    isNew: true,
  ...
  },
  {
    ...
    description: "Real-time revenue intelligence dashboard tracking lead quality scores, automated pipeline values, and conversion bottlenecks.",
    category: "Analytics & Reporting",
    iconName: "TrendingUp",
    status: "active",
    isNew: true,
  ...
  },
  {
    ...
    description: "Server-side 6-digit verification code generation displayed as a one-tap hint button that auto-fills and validates user inputs during registration and login.",
    category: "Security & Compliance",
    iconName: "Lock",
    status: "active",
    isNew: true,
  ...
  },
  {
    ...
    description: "Real-time synchronization between Admin agent management and the Customer Intake Form, instantly reflecting added or deleted agents in dropdown selectors.",
    category: "Core Platform",
    iconName: "Users",
    status: "active",
    isNew: true,
  ...
  },
  {
    ...
    description: "Dedicated workspace environment featuring live campaign management, GTM intakes, report generation, call dialer controls, and seamless portal navigation.",
    category: "Core Platform",
    iconName: "Briefcase",
    status: "active",
    isNew: true,
